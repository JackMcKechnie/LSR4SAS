...
def read_sensitivity_labels(file):
    with open(file, "r") as f:
        sensitivity_labels = json.load(f)
    return sensitivity_labels

class MultipleNegativesClassification(Dataset):
    def __init__(
        self,
        collection_path: str,
        queries_path: str,
        ...
        self.sensitivity_labels = read_sensitivity_labels(sensitivity_labels_path)
    ...
    def __getitem__(self, item):
        ...
        sensitivity_labels = []
        sensitivity_labels.append(self.sensitivity_labels[pos_id])
        sensitivity_labels.extend([self.sensitivity_labels[neg] for neg in negs])
        
        return query, group_batch, sensitivity_labels