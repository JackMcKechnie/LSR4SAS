...
from data import OHSUMEDProportionateRandomSensitiveDataset, MsMarcoCollator, SPLADEArgs
from model import SPLADEModel
from trainer import IRTrainer

ds = OHSUMEDProportionateRandomSensitiveDataset()

args = SPLADEArgs("./training_ouput_dir/")
...
args.per_device_train_batch_size = 4  # number of gpus needs to divide this
...
trainer.train()
model.save("splade_model", tokenizer = tokenizer)